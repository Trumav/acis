...
.header{
  background-image: url("img/bg/bg-head-home.png");
  height:70px;
  padding:10px;
}
a.logo-home{
...
.owner{
  ...
  <div class="header">    
    <div class="container">
      ...
      <a href="https://www.facebook.com/" class="pull-right"> <h4>Muhammad Quillen</h4></a>
      <a href="https://www.facebook.com/" class="owner" ><h4>Andrian Wara Wiri</h4></a>
    </div>
    <div id="wrapshopcart">
      <div class="col-md-12">
